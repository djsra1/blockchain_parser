...
block_explorer_url  = "https://blockchain.info/rawaddr/"
#$bitcoin_address
#https://blockexplorer.com/api/addrs/"
#?from=0&to=50
...
def get_all_transactions(bitcoin_address):
    ...
    block_explorer_url_full = block_explorer_url + bitcoin_address + "?offset=%d&limit=%d" % (from_number,to_number)
    
    response = requests.get(block_explorer_url_full)
    print (block_explorer_url_full)
    try:
